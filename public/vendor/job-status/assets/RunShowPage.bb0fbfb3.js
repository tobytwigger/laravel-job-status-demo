import { d as commonjsGlobal, b as QSeparator, c as client$1, Q as QBreadcrumbsEl, a as QBreadcrumbs } from "./index.0dd3d626.js";
import { g as getBtnDesignAttr, Q as QBtn } from "./QBtn.498dc09a.js";
import { c as createComponent, h as hSlot, e as hMergeSlot, b as createDirective, a as hUniqueSlot, d as hDir } from "./render.2c6f0e6d.js";
import { c as computed, h, j as emptyRenderFn, r as ref, k as onBeforeUnmount, o as onMounted, a as inject, D as withDirectives, a2 as tabsKey, q as stopAndPrevent, Y as isKeyCode, a3 as shouldIgnoreKey, g as getCurrentInstance, a4 as isDeepEqual, Z as onDeactivated, n as nextTick, w as watch, a5 as onActivated, E as provide, m as client, u as noop, v as leftClick, x as addEvt, y as preventDraggable, B as position, C as cleanEvt, X as Transition, a6 as KeepAlive, a7 as timelineKey, _ as _export_sfc, K as defineComponent, L as openBlock, S as createElementBlock, F as Fragment, U as renderList, M as createBlock, N as withCtx, Q as toDisplayString, R as createBaseVNode, a0 as unref, P as createTextVNode, O as createCommentVNode, d as createVNode } from "./index.c9c99a36.js";
import { u as useTimeout, Q as QResizeObserver, g as getModifierDirections, s as shouldStart, c as clearSelection, a as QBanner } from "./QBanner.4827257c.js";
import { u as useDarkProps, a as useDark, d as QList, c as QItem, Q as QItemSection, b as QItemLabel } from "./QItem.d72dec2c.js";
import { R as Ripple, Q as QIcon, i as vmIsDestroyed, j as getNormalizedVNodes, d as useAlignProps, f as useAlign, k as getParentProxy } from "./use-router-link.f56975ac.js";
import { Q as QPage } from "./QPage.17c7e3d4.js";
import { d as dayjs } from "./dayjs.min.33f4ae70.js";
import { l as localizedFormat } from "./localizedFormat.79c710f6.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let listener = client$1.runs.show(props.jobStatusId).bypassAuth().listen().onUpdated((newResults) => results.value = newResults).start();
    onBeforeUnmount(() => {
      listener.stop();
    });
    ...
    function cancel() {
      ...
      client$1.runs.cancel(props.jobStatusId).bypassAuth().send().finally(() => cancelling.value = false);
    }
    const retrying = ref(false);
    function retry() {
      retrying.value = true;
      client$1.runs.retry(props.jobStatusId).bypassAuth().send().finally(() => retrying.value = false);
    }
              ...
              createBaseVNode("div", _hoisted_6, [
                createVNode(QBtnGroup, { rounded: "" }, {
                  default: withCtx(() => [
                    ...
                    unref(selectedRun).connection_name && unref(selectedRun).queue && unref(selectedRun).has_payload ? (openBlock(), createBlock(QBtn, {
                      key: 2,
                      disable: retrying.value,
