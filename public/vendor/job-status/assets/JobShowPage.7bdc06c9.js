...
import { _ as _export_sfc, K as defineComponent, L as openBlock, M as createBlock, N as withCtx, d as createVNode, P as createTextVNode, Q as toDisplayString, R as createBaseVNode, r as ref, S as createElementBlock, F as Fragment, U as renderList, O as createCommentVNode, k as onBeforeUnmount, D as withDirectives } from "./index.c9c99a36.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const results = ref(null);
    let listener = client.jobs.show(props.alias).bypassAuth().listen().onUpdated((newResults) => results.value = newResults).start();
    onBeforeUnmount(() => {
      listener.stop();
    });
