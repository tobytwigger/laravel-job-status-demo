...
import { Q as QCircularProgress } from "./QCircularProgress.51d8a663.js";
...
import { _ as _export_sfc, K as defineComponent, c as computed, L as openBlock, M as createBlock, N as withCtx, d as createVNode, a0 as unref, O as createCommentVNode, P as createTextVNode, Q as toDisplayString, R as createBaseVNode, r as ref, k as onBeforeUnmount, S as createElementBlock, U as renderList, F as Fragment } from "./index.c9c99a36.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let listener = client.runs.search().bypassAuth().listen().onUpdated((newResults) => results.value = newResults).start();
    onBeforeUnmount(() => {
      listener.stop();
    });
    return (_ctx, _cache) => {
